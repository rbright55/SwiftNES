...
class Memory {
	...
	*/
	...
	final func readTwoBytesMemory(_ address: Int) -> Int {
		return Int(readMemory(address + 1)) << 8 | Int(readMemory(address))
	}
    ...
    final func writeTwoBytesMemory(_ address: Int, data: Int) {
